...
class PrescriptionItemInputSerializer(serializers.Serializer):
    ...
    morning = serializers.CharField(max_length=10, allow_blank=True, default="0")
    afternoon = serializers.CharField(max_length=10, allow_blank=True, default="0")
    evening = serializers.CharField(max_length=10, allow_blank=True, default="0")
